...
if ($_SESSION['tipo_cuenta'] !== 'cliente') {
    header("Location: profesional.php?mensaje=" . urlencode("Esta sección es solo para clientes"));
    exit();
}
                ...
                <div class="nav-left">
                    <ul style="display: flex; list-style: none; gap: 20px; margin: 0; padding: 0;">
                        <li><a href="../../index.html">Inicio</a></li>
                        				<li><a href="buscar-servicios.php">Buscar Servicios</a></li>
                        <li><a href="buscar.html">Explorar</a></li>
                    </ul>
                </div>
                <div class="nav-right">
                    <div class="user-menu">
    ...
    <main class="dashboard-container">
        <section class="welcome-section">
            ...
            <div class="nav-actions">
                			<a href="buscar-servicios.php" class="nav-btn">Buscar Servicios</a>
                <a href="buscar.html" class="nav-btn">Explorar Categorías</a>
            </div>
        </section>
