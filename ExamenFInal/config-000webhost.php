<?php
// ========================================
// CONFIGURACIÓN PARA 000WEBHOST
// ========================================
// INSTRUCCIONES SUPER FÁCILES:
// 1. Ve a cPanel → MySQL Databases
// 2. Crea base de datos y usuario
// 3. Copia los datos de abajo
// 4. Renombra este archivo a "config.php"

// DATOS DE LA BASE DE DATOS (REEMPLAZA CON TUS DATOS)
define('DB_HOST', 'localhost');
define('DB_NAME', 'tu_usuario_conecta_cusco_db'); // Tu nombre de BD
define('DB_USER', 'tu_usuario_conecta_user'); // Tu usuario
