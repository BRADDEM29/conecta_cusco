...
// 4. Copia los datos de abajo y reemplázalos aquí
// 5. Renombra este archivo a "config.php"

// DATOS DE LA BASE DE DATOS (REEMPLAZA CON TUS DATOS REALES)
define('DB_HOST', 'sql.epizy.com'); // Host de InfinityFree
define('DB_NAME', 'tu_usuario_conecta_cusco_db'); // Nombre de tu BD
define('DB_USER', 'tu_usuario_conecta_cusco'); // Usuario de tu BD
define('DB_PASS', 'tu_contraseña_bd'); // Contraseña de tu BD
